...
//// subscribers, publishers, services  
    ...
    ros::Subscriber bool_sub1=nh.subscribe("/bools_from_cv1", 1000, receive_bool1);
    ros::Subscriber bool_sub2=nh.subscribe("/bools_from_cv2", 1000, receive_bool2);
    ros::Subscriber bool_sub3=nh.subscribe("/bools_from_cv3", 1000, receive_bool3); 
    ros::Subscriber float_sub=nh.subscribe("/floats_from_cv", 1000, receive_float); 
